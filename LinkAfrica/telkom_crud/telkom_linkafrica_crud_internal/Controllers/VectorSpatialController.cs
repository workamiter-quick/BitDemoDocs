    ...
    public class VectorSpatialController : ControllerBase
    {
        ...
        public IActionResult GetSiteDetail(GoogleCoord _GoogleCoord)
        {
            ...
            try
            {
                ...
                string productPriceQuery = "SELECT n0, sub_n0, xxx, los, product, sheet, contract_term_months, bandwidth_mbps, mrc_ex_vat, " +
                ...
                {
                    objSiteDetails.chkUseMaxDistance = bool.Parse(_GoogleCoord.UseMaxDistance);
                    objSiteDetails.chkDDMaxDistance = bool.Parse(_GoogleCoord.DDMaxDistance);
                    foreach (DataRow drr in ProductPrice_Ds.Tables[0].Rows)
                    {
                        if (objSiteDetails.Product == drr["xxx"].ToString())
                        {
                            ...
                            objSiteDetails.LOS = drr["los"].ToString();
