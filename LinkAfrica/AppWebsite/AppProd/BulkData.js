    ...
    reader.onload = async function (e) {
        ...
        for (let i = 0; i < dataRows.length; i++) {
            ...
            try {
                ...
                const url = `http://tectonicstechnologysaprod.dedicated.co.za/LAAPI/Apps/getfeasibility?key=c849173a295e44c3905e1086700afcc8&latitude_y=${latitude}&longitude_x=${longitude}&term=${term}&_=${cacheBuster}`;
